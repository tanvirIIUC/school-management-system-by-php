...
$id=$_GET['id'];
	...
	$query=mysqli_query($connection,"select * from teacher_info where id='$id'");
...
<div class="col-sm-6">
    ...
    <form action="t_update.php?id=<?php echo $id;?>" method="POST">
         <p>
           ...
           <input type="text" value="<?php echo $row['Username']; ?>" name="tname" required/>
         </p>
        
         <p>
             <label>Id</label>
             <input type="text"value="<?php echo $row['T_id']; ?>" name="tid" required>
         </p>
         <p>
         <label>phone</label>
